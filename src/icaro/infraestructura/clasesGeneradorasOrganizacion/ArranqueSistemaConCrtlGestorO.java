...
public class ArranqueSistemaConCrtlGestorO {
    ...
    public static void main(String args[]) {
        ...
        if (args.length == 0) {
            ...
            int opcion = JOptionPane.showConfirmDialog(new JFrame(), "Descripcion de Organizacion no encontrado. Desea arrancar el asistente de creación de Descripcion de Organizacion?", "Confirmacion", JOptionPane.YES_NO_OPTION);
