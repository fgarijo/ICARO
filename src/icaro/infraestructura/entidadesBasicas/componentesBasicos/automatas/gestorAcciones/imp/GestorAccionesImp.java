...
import icaro.infraestructura.patronAgenteCognitivo.procesadorObjetivos.gestorTareas.imp.*;
 ...
 * @author 
 */
public class GestorAccionesImp implements ItfGestorTareas{
    private AgenteCognitivo agente;
    private ItfAutomataEFconGestAcciones envioHechos;
